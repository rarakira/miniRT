...
static int	get_caps(t_eq *caps, t_object *obj, t_vector ray)
{
	...
	{
		obj->hit_point = vect_mult(ray, caps->dist1);
...
static float	get_distance(t_object *obj, t_vector ray, t_eq body)
{
	...
	else
	{
		...
		{
			// printf("body 1: body.d1 = %f, caps.d1 = %f\n", body.dist1, caps.dist1);
			obj->dist = body.dist1;
			obj->m = body.m1;
		}
		else if (in_range(body.m2, obj->height) &&  (body.dist2 < caps.dist1 || caps.dist1 < MIN_DIST))
		{
			// printf("body 2: body.d2 = %f, caps.d1 = %f\n", body.dist2, caps.dist1);
			obj->dist = body.dist2;
			obj->m = body.m2;
		}
		else
		{
			// printf("CAPS : caps.d1 = %f, caps.d2 = %f, d1 = %f, d2 = %f\n", caps.dist1, caps.dist2, body.dist1, body.dist2);
			// printf("h = %f, m1 = %f, m2 = %f\n", obj->height, body.m1, body.m2);
			obj->dist = caps.dist1;
			obj->m = caps.m1;
